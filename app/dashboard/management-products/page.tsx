      ...
      <div className="mb-8 flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
        <div className="flex items-start gap-4">
          <div className="flex items-center gap-3">
            <Icon name="UtensilsCrossed" className="h-8 w-8 text-feature-products icon-enhanced" />
            <div>
              <h1 className="text-3xl font-bold text-primary">إدارة الأطباق</h1>
              <p className="text-sm text-muted-foreground mt-1">
                عرض جميع الأطباق، التصفية، والبحث، مع إمكانية إضافة طبق جديد.
              </p>
            </div>
          </div>
        </div>
