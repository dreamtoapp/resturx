  ...
  >
    <Card className='mb-6'>
      ...
      <CardContent className='space-y-4 text-lg'>
        <p>
          مرحباً بك في لوحة تحكم المتجر. هذا الدليل يوضح لك كيفية إدارة الأطباق، العروض، أنواع المطابخ،
        ...
        <ul className='list-decimal space-y-2 pr-6'>
          ...
          <li>
            ...
            <ul className='mt-2 list-disc space-y-1 pr-6 text-base'>
              <li>
                <b>صور الأطباق:</b> 800×800 بكسل (نسبة 1:1)
              </li>
              <li>
                <b>شعار المتجر:</b> 300×100 بكسل أو SVG
              </li>
              <li>
                <b>صور أنواع المطابخ (أعلام البلدان):</b> 320 بكسل عرض (تلقائي من flagcdn.com)
              </li>
              <li>
    ...
    <Card className='mb-6'>
      ...
      <CardContent className='space-y-2'>
        <ul className='list-disc space-y-2 pr-6'>
          <li>احرص على تحديث بيانات الأطباق وأنواع المطابخ باستمرار.</li>
    ...
    <Card>
      ...
      <CardContent className='space-y-2'>
        <ul className='list-disc space-y-2 pr-6'>
          ...
          <li>كيف أضيف نوع مطبخ جديد؟ من صفحة أنواع المطابخ اضغط إضافة نوع مطبخ.</li>
